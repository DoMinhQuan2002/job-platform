...
export const usersService = {
  ...
  async getMyProfile(userId: string) {
    ...
    return { id: user.id, roleId: user.roleId || user.role.id, email: user.email, fullName: user.fullName, phone: user.phone, avatar, dateOfBirth: user.dateOfBirth, addressDetail: user.addressDetail, wardCode: user.wardCode, lastLoginAt: user.lastLoginAt, emailVerifiedAt: user.emailVerifiedAt };
  },
